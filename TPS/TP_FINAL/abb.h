...
//____________________________ITERADOR_EXTERNO__________________________//

/*
 * Crea un iterador para un arbol.El iterador creado es válido desde
 * el momento de su creación hasta que no haya mas elementos por
 * recorrer o se modifique el arbol iterado (agregando o quitando
 * elementos del arbol).
 * El recorrido se realiza de acuerdo al recorrido solicitado.  Los
 * recorridos válidos son: ABB_RECORRER_INORDEN, ABB_RECORRER_PREORDEN
 * y ABB_RECORRER_POSTORDEN.
...
/*
 * Devuelve true si hay mas elementos sobre los cuales iterar segun el recorrido 
 * o false en caso contrario.
 */
bool abb_iterador_tiene_siguiente(abb_iterador_t* iterador);

/*
 * Avanza el iterador al proximo elemento segun el recorrido
 * En caso de error devuelve NULL.
 */
void abb_iterador_siguiente(abb_iterador_t* iterador);

/*
 * Resetea el iterador, moviendolo a la primera posicion
 */
void abb_iterador_inicio(abb_iterador_t* iterador);

/*
 * Destruye el iterador liberando la memoria reservada por el mismo.
 */
